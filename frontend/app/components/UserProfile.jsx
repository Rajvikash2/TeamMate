...
import { Calendar, Github, Mail, MapPin, Award, Users, Bookmark, MessageSquare } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="w-full md:w-80 flex-shrink-0">
                    <div className="bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="relative px-4 pt-0 pb-4">
                            ...
                            <h2 className="text-lg font-bold text-black">{userProfile.name}</h2>
                            <p className="text-sm text-gray-500">u/{userProfile.name.replace(/\s+/g, '')}</p>

                            {/* Reddit-style karma stats */}
                            <div className="mt-4 flex items-center justify-between">
                                <div className="text-center">
                                    <p className="text-xs text-gray-500">Followers</p>
                                    <p className="font-medium text-gray-400">{userProfile.followers || "6,476"}</p>
                                </div>
                                <div className="text-center">
                                    <p className="text-xs text-gray-500">Connections</p>
                                    <p className="font-medium text-gray-400">{userProfile.connections || "500+"}</p>
                                </div>
                                <div className="text-center">
                            ...
                            <div className="mt-4 space-y-2">
                                ...
                                <UpdateProfile profile={userProfile} onUpdate={handleProfileUpdate} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-700">One-Year Club</p>
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-4 bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-4">
                            <div className="mb-4">
                                <h4 className="text-sm font-medium mb-2 text-gray-600">Skills</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-medium mb-2 text-gray-600">Domains of Interest</h4>
                                <div className="flex flex-wrap gap-2">
                                    {userProfile.doi && userProfile.doi.length > 0 ? (
                                        ...
                                        <span className="text-sm text-gray-500">No domains added yet</span>
                                    )}
                                </div>
                            </div>
                        </div>
